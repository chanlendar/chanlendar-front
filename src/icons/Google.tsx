...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		<g clipPath="url(#a)">
			...
			/>
			<path
				d="M4.397 11.937a6.008 6.008 0 0 1-.34-1.971c0-.687.125-1.351.33-1.971l-.007-.132-3.187-2.42-.104.05A9.79 9.79 0 0 0 0 9.965a9.79 9.79 0 0 0 1.088 4.473l3.308-2.502Z"
				fill="#FBBC05"
			/>
			<path
				d="M10.2 3.853c1.914 0 3.206.809 3.943 1.484l2.878-2.746C15.253.986 12.953 0 10.199 0 6.211 0 2.766 2.237 1.09 5.492l3.297 2.503A6.152 6.152 0 0 1 10.2 3.853Z"
				fill="#EB4335"
			/>
		</g>
		<defs>
